...
namespace StockExchangeInterfaces
{
    public class StockExchange : IStockExchange
    {
        ...
        private readonly IList<IBroker> _brokers = new List<IBroker>(); 
        ...
        public void UnsubscribeBroker(IBroker broker)
        {
            ...
            else throw new BrokerNotFoundExeption("Cannot unsubscribe broker. Broker is not subscribed! Please subscibe first.");
        }
        ///// <summary>
        ...
        public string RequestSelling(string securityId, int amount, IBroker broker)
        {
            ...
            var eventsLogger = new StockExhangeEventsLogger();
            eventsLogger.OnSelling(dealInfo);
            OnSelling(dealInfo);
