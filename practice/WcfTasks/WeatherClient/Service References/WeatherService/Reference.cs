...
namespace WeatherClient.WeatherService {
    ...
    public interface WeatherSoap {
        ...
        WeatherClient.WeatherService.GetWeatherInformationResponse GetWeatherInformation(WeatherClient.WeatherService.GetWeatherInformationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetWeatherInformation", ReplyAction="*")]
        System.Threading.Tasks.Task<WeatherClient.WeatherService.GetWeatherInformationResponse> GetWeatherInformationAsync(WeatherClient.WeatherService.GetWeatherInformationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityForecastByZIP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        WeatherClient.WeatherService.ForecastReturn GetCityForecastByZIP(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityForecastByZIP", ReplyAction="*")]
        System.Threading.Tasks.Task<WeatherClient.WeatherService.ForecastReturn> GetCityForecastByZIPAsync(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        WeatherClient.WeatherService.WeatherReturn GetCityWeatherByZIP(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP", ReplyAction="*")]
        System.Threading.Tasks.Task<WeatherClient.WeatherService.WeatherReturn> GetCityWeatherByZIPAsync(string ZIP);
    }
    ...
    public partial class GetWeatherInformationResponse {
        ...
        public WeatherClient.WeatherService.WeatherDescription[] GetWeatherInformationResult;
        
        public GetWeatherInformationResponse() {
        }
        
        public GetWeatherInformationResponse(WeatherClient.WeatherService.WeatherDescription[] GetWeatherInformationResult) {
            this.GetWeatherInformationResult = GetWeatherInformationResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WeatherSoapChannel : WeatherClient.WeatherService.WeatherSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WeatherSoapClient : System.ServiceModel.ClientBase<WeatherClient.WeatherService.WeatherSoap>, WeatherClient.WeatherService.WeatherSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WeatherClient.WeatherService.GetWeatherInformationResponse WeatherClient.WeatherService.WeatherSoap.GetWeatherInformation(WeatherClient.WeatherService.GetWeatherInformationRequest request) {
            return base.Channel.GetWeatherInformation(request);
        }
        
        public WeatherClient.WeatherService.WeatherDescription[] GetWeatherInformation() {
            WeatherClient.WeatherService.GetWeatherInformationRequest inValue = new WeatherClient.WeatherService.GetWeatherInformationRequest();
            WeatherClient.WeatherService.GetWeatherInformationResponse retVal = ((WeatherClient.WeatherService.WeatherSoap)(this)).GetWeatherInformation(inValue);
            return retVal.GetWeatherInformationResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<WeatherClient.WeatherService.GetWeatherInformationResponse> WeatherClient.WeatherService.WeatherSoap.GetWeatherInformationAsync(WeatherClient.WeatherService.GetWeatherInformationRequest request) {
            return base.Channel.GetWeatherInformationAsync(request);
        }
        
        public System.Threading.Tasks.Task<WeatherClient.WeatherService.GetWeatherInformationResponse> GetWeatherInformationAsync() {
            WeatherClient.WeatherService.GetWeatherInformationRequest inValue = new WeatherClient.WeatherService.GetWeatherInformationRequest();
            return ((WeatherClient.WeatherService.WeatherSoap)(this)).GetWeatherInformationAsync(inValue);
        }
        
        public WeatherClient.WeatherService.ForecastReturn GetCityForecastByZIP(string ZIP) {
            return base.Channel.GetCityForecastByZIP(ZIP);
        }
        
        public System.Threading.Tasks.Task<WeatherClient.WeatherService.ForecastReturn> GetCityForecastByZIPAsync(string ZIP) {
            return base.Channel.GetCityForecastByZIPAsync(ZIP);
        }
        
        public WeatherClient.WeatherService.WeatherReturn GetCityWeatherByZIP(string ZIP) {
            return base.Channel.GetCityWeatherByZIP(ZIP);
        }
        
        public System.Threading.Tasks.Task<WeatherClient.WeatherService.WeatherReturn> GetCityWeatherByZIPAsync(string ZIP) {
